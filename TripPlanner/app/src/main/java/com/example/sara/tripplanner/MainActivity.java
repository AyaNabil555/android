        ...
        GoogleApiClient.ConnectionCallbacks, View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /// UserEmail=(TextView)findViewById(R.id.userEmail);
        ...
        reference = database.getReference("Trip").child(user.getUid());
...
//          intent.setData(Uri.parse("geo:19.067.877"));
//          startActivity(intent);
    ...
    public void getValues(){
        ...
        aprogress.show();
        Trip trip=new Trip(Name,Date,Time,Note,PlaceForm,PlaceTo);
        reference.push().setValue(trip);
        aprogress.dismiss();
        Toast.makeText(MainActivity.this,"Insetrted",Toast.LENGTH_LONG).show();
